    ...
    export default {
        data() { //选项 / 数据
            return {
                ...
                catchMeObj:{//抓住我 个人信息
                    Qinlh:{
                        git:'https://github.com/plasticlove1984',
                        qq: 'static/img/qinlh/qq.jpg',
                        sina: 'https://weibo.com/u/7408251106/home',
                        wechat: 'static/img/qinlh/wechat.jpg',
                        csdn: 'https://blog.csdn.net/u012318057?spm=1000.2115.3001.5343',
                        job: 'https://jlcr.haitou.cc/attachmentResumeView?resume_id=1964148'
                    },
                    Aimee:{
                        git: 'https://github.com/plasticlove1984',
