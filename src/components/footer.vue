...
98% {
    ...
    0%,100% {
    	-webkit-transform:translate(0,0.1px) rotate(0);
    	-moz-transform:translate(0,0.1px) rotate(0);
    	-ms-transform:translate(0,0.1px) rotate(0);
    	-o-transform:translate(0,0.1px) rotate(0);
    	transform:translate(0,0.1px) rotate(0)
    }
}
</style>
